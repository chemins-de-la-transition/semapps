                ...
                </Box>
                {
                    ...
                    ? 
                        <ReferenceField source={subheaderSource} reference="Type" {...props} linkType="show">
                            <TextField source="pair:label" variant="subtitle2" component="div" className={classes.basePath+' '+classes.noDecoration}/>
                        </ReferenceField>
                    : <Typography variant="subtitle2" component="div">{subheaderDefault}</Typography>
                }

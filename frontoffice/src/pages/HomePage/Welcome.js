...
const WelcomeContent = ({ classesNames }) => {
  return (
    <FullWidthBox>
      <LargeContainer className={classesNames.welcomeContainer}>
        <ReactComment text={'Image : (Free to Use and no attribution required) Zen Chung @pexels' +
            ...
            <Box display="flex" justifyContent="center" flexDirection="column">
              <Typography variant="h1" className={classesNames.welcomeText}>Apprendre en voyageant</Typography>
              <div className={classesNames.welcomeTextBar}></div>
              <Typography variant="body1" className={classesNames.welcomeSubtitleText} component="div">

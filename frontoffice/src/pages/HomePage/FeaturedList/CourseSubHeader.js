...
const Duration = ({record}) => {
  ...
  return (duration)
    ? <Typography variant="body2" className={classes.text}>{duration}</Typography>
    :'';
};
      ...
      <Box className={classes.courseSubHeader}>
        {
          ...
          ? <><DurationIcon ></DurationIcon><Duration record={record} {...rest}/></>
          : ''
        }
        {

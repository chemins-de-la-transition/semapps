      ...
      <LargeContainer className={classes.frontBox}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item sm={6} md={4} lg={3} className={classes.thirdText}>
            ...
            <ul className={classes.ulStyle}>
              <ListGoalsItem text="Des voyages immersifs par secteurs d'activité pour accéder facilement aux pratiques émergentes dans tous les domaines de la transition." />
              <ListGoalsItem text="Des voyages avec plusieurs niveaux de découverte et d’apprentissage en faisant." />

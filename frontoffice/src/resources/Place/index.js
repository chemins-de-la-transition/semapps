...
export default {
  ...
  translations: {
    ...
    en: {
      ...
      fields: {
        'pair:label': 'Name',
        'cdlt:hasPublicationStatus':'Publication state',
        'pair:comment': 'Comment',
        'pair:depictedBy': 'Image',
        'cdlt:hasRegion': 'Region',
        'pair:hasSector': 'Activity sector',
        'pair:hasTopic': 'Keyword', /*Topic*/
        'cdlt:hasCourseType': 'Course type',
        'pair:hasType': 'Type',
        'pair:hasStatus': 'State',
        'pair:description': 'Description',
